...
class C_dusun extends CI_Controller {
    ...
    function lists() {
		...
		$colModel['nik_kepala'] = array('NIK Kepala Dusun',150,TRUE,'center',2);
		$colModel['nama_kepala'] = array('Nama Kepala Dusun',150,TRUE,'center',2);
    ...
    function load_data() {	
        ...
        $this->load->library('flexigrid');
        $valid_fields = array('id_dusun','kode_dusun_bps','kode_dusun_kemendagri','nama_dusun','luas_wilayah','id_desa','nik_kepala','nama_kepala');
...
//				'<input type="button" value="Edit" class="ubah" onclick="edit_dusun(\''.$row->id_dusun.'\')"/>'
	...
	function simpan_dusun() {
		...
		$this->form_validation->set_rules('nik_kepala', 'Nik Kepala Dusun', 'required');
		$this->form_validation->set_rules('nama_kepala', 'Nama Kepala Dusun', 'required');
