	  ...
	  <div class="panel-body">
			...
			<?php echo form_open('admin/c_kegiatan/simpan'); ?>
			    ...
			    <div class="form-group">
			        ...
			        <div class="col-md-8">
			         <input type="text" class="form-control input-md" name="nama_kegiatan" id="nama_kegiatan" size="100" placeholder="Nama Kegiatan" required/>
			        ...
			        <div class="col-md-8">
			         <input type="text" class="form-control input-md" name="alamat_kegiatan" id="alamat_kegiatan" size="100" placeholder="Dusun - RT/RW" required/>
			         <span class="help-block">
					<?php echo form_error('username', '<p class="field_error">','</p>')?>
			        </span>
			        </div>
			        ...
			        <div class="col-md-8">
			         <input type="number" class="form-control input-md" name="telp_kegiatan" id="telp_kegiatan" size="100" placeholder="No. Telp" required/>
			         <span class="help-block">
					<?php echo form_error('username', '<p class="field_error">','</p>')?>
			        </span>
			        </div>
			        ...
			        <div class="col-md-8">
			         <input type="text" class="form-control input-md" name="user_kegiatan" id="user_kegiatan" size="100" placeholder="Username" required/>
			         <span class="help-block">
					<?php echo form_error('username', '<p class="field_error">','</p>')?>
			        </span>
			        </div>
			        ...
			        <div class="col-md-8">
			         <input type="password" class="form-control input-md" name="pass_kegiatan" id="pass_kegiatan" size="100" placeholder="Password" required/>
			         <span class="help-block">
					<?php echo form_error('username', '<p class="field_error">','</p>')?>
			        </span>
			        </div>
