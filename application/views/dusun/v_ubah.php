...
<legend></legend>
    ...
    <!-- Text input-->
    <div class="form-group">
       <label class="col-md-3 control-label" for="nik_kepala"> NIK Kepala Dusun </label>
        <div class="col-md-9">
        <span class="help-block">
         <input class="form-control input-md" type="number" name="nik_kepala" id="nik_kepala" size="30" value="<?= $hasil->nik_kepala?>" placeholder="NIK Kepala Dusun" required/> 
    <?php echo form_error('nik_kepala', '<p class="field_error">','</p>')?>
    </span>
    </div>
  </div>
    ...
    <!-- Text input-->
    <div class="form-group">
       <label class="col-md-3 control-label" for="nama_kepala"> Nama Kepala Dusun </label>
        <div class="col-md-9">
        <span class="help-block">
         <input class="form-control input-md" type="text" name="nama_kepala" id="nama_kepala" size="30" value="<?= $hasil->nama_kepala?>" placeholder="Nama Kepala Dusun" required/> 
    <?php echo form_error('nama_kepala', '<p class="field_error">','</p>')?>
    </span>
    </div>
  </div>
