...
<?php echo form_open('admin/c_dusun/simpan_dusun'); ?>
    ...
    <div class="form-group">
      <label class="col-md-3 control-label" for="nik_kepala">  NIK Kepala Dusun </label>
        <div class="col-md-9">
        <span class="help-block">
         <input class="form-control input-md" type="number" name="nik_kepala" id="nik_kepala" size="30" placeholder="NIK Kepala Dusun" required/> 
    ...
    <div class="form-group">
      <label class="col-md-3 control-label" for="nama_kepala">  Nama Kepala Dusun </label>
        <div class="col-md-9">
        <span class="help-block">
         <input class="form-control input-md" type="text" name="nama_kepala" id="nama_kepala" size="30" placeholder="Nama Kepala Dusun" required/> 
