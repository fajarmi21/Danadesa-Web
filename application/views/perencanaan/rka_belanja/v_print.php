    ...
    <table border="1" width="100%">
        <thead>
            <tr id="tr_head">
                ...
                <th width="10%;" rowspan="2" style="text-align:center;">Bidang</th>
                <th width="10%;" rowspan="2" style="text-align:center;">Program</th>
                <th width="10%;" rowspan="2" style="text-align:center;">Ketua Kegiatan</th>
                <th width="5%;" rowspan="2" style="text-align:center;">Tahun</th>
                <th width="10%;" rowspan="2" style="text-align:center;">Tingkat Kegiatan</th>
                <th width="20%;" rowspan="2" style="text-align:center;">Keterangan</th>
                <th width="15%;" rowspan="2" style="text-align:center;">Rencana Dimulai</th>
                <th width="15%;" rowspan="2" style="text-align:center;">Anggaran</th>
            </tr>
            <!-- <tr id="tr_head2">
                <th width="5%">Kode</th>
        ...
        <tbody>
          ...
          foreach ($v_data->result() as $baris) {?>
            <tr id="tr">
              ...
              <td><?php echo $baris->tingkat_kegiatan; ?></td>
