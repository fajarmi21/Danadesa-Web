...
<!-- <div class="navbar-default sidebar" role="navigation"> -->
            ...
            <!---------------------DROPDOWN 7--------------------------------------------------------------->
						<li class="dropdownmenu">
						<a id="a-data-penganggaran" class="collapsed" data-toggle="collapse" href="#penganggaran">
						<i class="fa fa-money fa-fw"></i> Penganggaran <span class="fa arrow"></span></a>
						<div id="penganggaran" class="collapse">
						<ul id="" class="nav nav-pills nav-stacked nav-second-level">

							<li id="nav-bidang_kegiatan" class="">
								<a href="<?php echo site_url('datapenduduk/c_bidang_kegiatan/');?>"><i class="fa fa-briefcase fa-fw"></i> Bidang & Kegiatan</a>
							</li>

              <li id="nav-data_anggaran" class="">
								<a href="<?php echo site_url('datapenduduk/c_data_anggaran/');?>"><i class="fa fa-money fa-fw"></i> Data Anggaran</a>
							</li>

							<li id="nav-pendapatan" class="">
								<a href="<?php echo site_url('datapenduduk/c_pendapatan/');?>"><i class="fa fa-credit-card fa-fw"></i> Pendapatan</a>
							</li>

							<li id="nav-belanja" class="">
								<a href="<?php echo site_url('datapenduduk/c_belanja/');?>"><i class="fa fa-shopping-cart fa-fw"></i> Belanja</a>
							</li>

              <li id="nav-pembiayaan" class="">
								<a href="<?php echo site_url('datapenduduk/c_pembiayaan/');?>"><i class="fa fa-tags fa-fw"></i> Pembiayaan</a>
							</li>

              <!-- <li id="nav-pengeluaran" class="">
								<a href="<?php echo site_url('datapenduduk/c_pengeluaran/');?>"><i class="fa fa-share-square-o fa-fw"></i> Pengeluaran</a>
							</li> -->

              <li id="nav-lap_penganggaran" class="">
								<a href="<?php echo site_url('datapenduduk/c_lap_anggaran/');?>"><i class="fa fa-print fa-fw"></i> Cetak Penganggaran</a>
							</li>
						...
						<li>
							<a href="<?php echo site_url('kontak');?>" id="a-kontak" class="" ><i class="fa fa-user"></i> Kontak</a>
						</li>
						<li>
							<a href="<?php echo site_url('sms_gateway/');?>" id="a-sms" class="" ><i class="fa fa-envelope fa-fw"></i> Sms Gateway</a>
						</li>
						<li>
