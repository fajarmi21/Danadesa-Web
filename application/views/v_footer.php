		...
		<div class="row">
			<div class="col-sm-6">
				<div class="footer-content">
					<h2>SIDeKa</h2>					
					<legend></legend>
					<p><h4>Sistem Informasi Desa</h4></p>
					<div class="row">
						<div class="col-md-6 col-sm-12 col-xs-12">
							<ul class="list-icons">
							<li><i class="fa fa-map-marker"></i>Kantor Desa Dukuh</li>
							<li><i class="fa fa"></i>Jl. Tamrin, Krajan, Dukuh</li>
							<li><i class="fa "></i>Kec. Ngadiluwih Kab.Kediri <br></li>						
						</ul>
						</div>
						<div class="col-md-6 col-sm-12 col-xs-12">
						<ul class="list-icons">
						<li><i class="fa fa-phone pr-10"></i> +6221 8378 9729</li>
						<li><i class="fa fa-envelope-o pr-10"></i> dukuhcity@gmail.com</li>
						<li><i class="fa fa-mobile-phone pr-10"></i> +62821 2188 5876</li>
						</ul>
							<ul class="social-links circle">
							<li class="link"><a target="_blank" href="" title="Website Perangkat Desa"><i class="fa fa-link"></i></a></li>
							<li class="facebook"><a target="_blank" href="" title="Facebook Perangkat Desa"><i class="fa fa-facebook"></i></a></li>
							<li class="twitter"><a target="_blank" href="" title="Twitter Perangkat Desa"><i class="fa fa-twitter"></i></a></li>
							<li class="googleplus"><a target="_blank" href="" title="Google+ Perangkat Desa"><i class="fa fa-google-plus"></i></a></li>
							</ul>
						</div>
