...
<div class="form-group">
   <label  class="col-md-2 control-label" for="tgl">Pilih Tahun Anggaran</label>
    <div class="col-md-2">
...
function nav_active(){
  ...
  document.getElementById("a-lap").className = "collapsed active";
	...
	var d = document.getElementById("nav-lra");
...
function btnproses()
{
  ...
  window.open("<?=$this->config->item('base_url');?>admin/c_perencanaan/print_rka_belanja/"+thn, "_blank");
}
