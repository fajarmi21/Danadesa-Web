...
<div class="col-md-8">
	<div class="panel panel-default">
	  ...
	  <div class="panel-body">
			...
			<?php echo form_open('admin/c_pelaksanaan/simpan_spp'); ?>

				<div class="form-group">
					 <label  class="col-md-4 control-label" for="tgl">Tanggal</label>
						<div class="col-md-8">
							<input type="text" class="form-control input-md" name="tgl" id="tgl" value="<?php echo date('d-m-Y'); ?>" size="10" placeholder="Tanggal" required/>
 						 <span>&nbsp;</span>
 						</div>
				</div>
				<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="form-group">
					 <label  class="col-md-4 control-label" for="pemasukkan">Pemasukkan</label>
						<div class="col-md-8">
						 <input type="text" class="form-control input-md" name="pemasukkan" id="pemasukkan" size="100" placeholder="Pemasukkan" required/>
						 <span>&nbsp;</span>
 						</div>
				</div>
				<div class="form-group">
					 <label  class="col-md-4 control-label" for="pencairan">Pencairan s/d yang lalu</label>
						<div class="col-md-8">
						 <input type="text" class="form-control input-md" name="pencairan" id="pencairan" size="100" placeholder="Pencairan s/d yang lalu"/>
						 <span>&nbsp;</span>
 						</div>
				</div>
				<div class="form-group">
					 <label  class="col-md-4 control-label" for="permintaan">Permintaan Sekarang</label>
						<div class="col-md-8">
						 <input type="text" class="form-control input-md" name="permintaan" id="permintaan" size="100" placeholder="Permintaan Sekarang" required/>
						 <span>&nbsp;</span>
 						</div>
				</div>
				<div class="form-group">
					 <label  class="col-md-4 control-label" for="jumlah">Jumlah s/d sekarang</label>
						<div class="col-md-8">
						 <input type="text" class="form-control input-md" name="jumlah" id="jumlah" size="100" placeholder="Jumlah s/d sekarang" required/>
						 <span>&nbsp;</span>
 						</div>
				</div>
				<div class="form-group">
					 <label  class="col-md-4 control-label" for="sisa_dana">Sisa Dana</label>
						<div class="col-md-8">
						 <input type="text" class="form-control input-md" name="sisa_dana" id="sisa_dana" size="100" placeholder="Sisa Dana" required/>
						 <span>&nbsp;</span>
 						</div>
				</div>
