...
<div class="col-md-6">
	<div class="panel panel-default">
	  ...
	  <div class="panel-body">
			...
			<?php echo form_open('admin/c_program/simpan'); ?>


			    <div class="form-group">
			    	 <label  class="col-md-4 control-label" for="nama_program">Nama Program</label>
			        <div class="col-md-8">
			         <input type="text" class="form-control input-md" name="nama_program" id="nama_program" size="100" placeholder="Nama Program" required/>
